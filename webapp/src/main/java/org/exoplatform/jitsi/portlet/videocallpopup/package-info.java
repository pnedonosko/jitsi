...
@Application(defaultController = JitsiMeetPopupApplication.class)
@Portlet(name = "JitsiMeetPopupPortlet")
@Bindings({
...
@Assets("*") package org.exoplatform.jitsi.portlet.videocallpopup;
